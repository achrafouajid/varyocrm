...
export class CrmStateService {
  ...
  resetWalkthrough() {
    ...
    // Reset CRM configuration states
    this.organization.set(SEED_ORG);
    this.users.set(SEED_USERS);
    this.teams.set(SEED_TEAMS);
    this.groups.set(SEED_GROUPS);
    this.groupMessages.set(SEED_MESSAGES);
    this.groupMeetings.set(SEED_MEETINGS);
