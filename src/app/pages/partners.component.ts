            ...
            <div>
              <div class="flex items-start justify-between mb-4">
                ...
                <span class="px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider rounded-full"
                  [class]="partner.type === 'Customer' ? 'bg-emerald-100 text-emerald-800' : (partner.type === 'Prospect' ? 'bg-blue-100 text-blue-800' : 'bg-amber-100 text-amber-800')">
                  {{partner.type}}
                </span>
              </div>
...
export class PartnersComponent {
  ...
  newPartner = {
    name: '',
    type: 'Prospect' as 'Prospect' | 'Customer' | 'Vendor',
    email: '',
    phone: '',
    city: 'Casablanca',
    comments: ''
